...
locals {
  ...
  server_farm_id = replace(coalesce(var.server_farm_id, var.service_plan_resource_id), "/(?i)/providers/microsoft\\.web/serverfarms//", "/providers/Microsoft.Web/serverfarms/")
