...
This example demonstrates how to configure hybrid connections for Web App deployment slots using the AVM Web Site module.

## Overview

This example creates:
- A Windows Web App with a deployment slot named "staging"
- An Azure Relay namespace and hybrid connection
- A hybrid connection configuration between the Web App slot and an on-premises endpoint

## Features Demonstrated

- Web App deployment slots configuration
